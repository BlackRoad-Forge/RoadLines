...
# RoadLines — OS Model Checker
# Copyright (c) 2025-2026 BlackRoad OS, Inc. All Rights Reserved.
# Based on MOSAIC (USENIX ATC'23) by Yanyan Jiang.
...
### 2.5 Misc and helper functions
    ...
    def state_dump(self) -> dict:
        ...
        def _safe_serialize(obj):
            """Make state JSON-serializable (handles generators, frames, etc.)."""
        ...
        safe_state = _safe_serialize(os_state)
        h = hash(json.dumps(safe_state, sort_keys=True)) + 2**63
        frozen = copy.deepcopy(os_state)
        frozen['hashcode'] = f'{h:016x}'
        return frozen
    ...
    def check(self) -> dict:
        ...
        class State:
            ...
            def extend(self, c):
                ...
                st.state['depth'] = self.state['depth'] + 1
                return st
